...
I focused on the Alu RE as a start as I never worked with methylation data.
```{r load}
...
remp_res_Alu <- read_rds(paste0(here::here(), "/remp_res_Alu_aggregate.rds"))
details(remp_res_Alu)
...
```{r}
glm(Alu_0000170_chr1_NM_001160184_PLEKHN1 ~
