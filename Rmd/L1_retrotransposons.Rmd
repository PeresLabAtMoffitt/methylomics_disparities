...
remp_res_Alu <- read_rds(paste0(here::here(), "/intermediary data/remp_res_Alu.rds"))
# remp_res_L1 <- remp(groomed_data,
#                  REtype = 'L1',
#                  parcel = remparcel_L1, ncore = 4, seed = 1234,
#                  work.dir = here::here())
# write_rds(remp_res_L1, "remp_res_L1.rds")
remp_res_L1 <- read_rds(paste0(here::here(), "/intermediary data/remp_res_L1.rds"))
# remp_res_ERV <- remp(groomed_data,
#                  REtype = 'ERV',
#                  parcel = remparcel_ERV, ncore = 4, seed = 1234,
#                  work.dir = here::here())
# write_rds(remp_res_ERV, "remp_res_ERV.rds")
remp_res_ERV <- read_rds(paste0(here::here(), "/intermediary data/remp_res_ERV.rds"))
```
...
remp_res_L1 <- read_rds(paste0(here::here(), "/intermediary data/remp_res_L1_aggregate.rds"))
details(remp_res_L1)
...
remp_res_L1 <- read_rds(paste0(here::here(), "/intermediary data/remp_res_L1_annotation.rds"))
