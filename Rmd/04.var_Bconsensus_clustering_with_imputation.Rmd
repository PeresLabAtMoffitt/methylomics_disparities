...
L1_df <- L1_imputed[rev(order(L1_var))[1:5000],]

Alu_var <- apply(Alu_imputed, 1, var) 
Alu_df <- Alu_imputed[rev(order(Alu_var))[1:5000],]

ERV_var <- apply(ERV_imputed, 1, var) 
ERV_df <- ERV_imputed[rev(order(ERV_var))[1:5000],]
```
...
# a <- bind_rows(as_tibble(ready_L1_df), as_tibble(ready_Alu_df), as_tibble(ready_ERV_df))
title <- "/Users/colinccm/Documents/GitHub/Peres/methylomics_disparities/clustering/var_temp_L1_consensus_plots"
...
#                  K= 2) # 15 min
# write_rds(bcc_res_4, "clustering/BCC/bcc_res2k_limiteddata_withvar_08022023.rds")
bcc_res_4 <- read_rds(paste0(here::here(), "/clustering/BCC/bcc_res2k_limiteddata_withvar_08022023.rds"))
...
#                              K = k,
#                              maxiter = 20)
#   save(cv.fit,file = paste("cv_var.fit.k",k,".Rdata",sep = ""))
# }
output=alist()
...
# write_rds(cluster_data, "clustering/MOVICS/var_movics_cluster_data_08032023.rds")
cluster_data <- readRDS("~/Documents/GitHub/Peres/methylomics_disparities/clustering/MOVICS/var_movics_cluster_data_08032023.rds")
```
...
#                          fig.name = "Best cluster number for methylation var_data_08082023")
knitr::include_graphics('/Users/colinccm/Documents/GitHub/Peres/methylomics_disparities/clustering/MOVICS/Best cluster number for methylation var_data_08082023.jpeg')
```
...
# 
# write_rds(cluster_res_list, "clustering/MOVICS/var_movics_cluster_res_list_08082023.rds")
cluster_res_list <- read_rds(paste0(here::here(), "/clustering/MOVICS/var_movics_cluster_res_list_08082023.rds"))
```
...
getMoHeatmap(data          = plot_cluster,
             ...
             fig.name      = "Comprehensive of NEMO_08082023")
...
getMoHeatmap(data          = plot_cluster_mvalue,
             ...
             width         = 10, # width of each subheatmap
             height        = 5, # height of each subheatmap
             fig.name      = "Comprehensive of NEMO M value_08082023")
```
...
getMoHeatmap(data          = plot_cluster,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of COCA_08082023")
...
getMoHeatmap(data          = plot_cluster_mvalue,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of COCA M value_08082023")
```
...
getMoHeatmap(data          = plot_cluster,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of ConsensusClustering_08082023")
...
getMoHeatmap(data          = plot_cluster_mvalue,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of ConsensusClustering M value_08082023")
```
...
getMoHeatmap(data          = plot_cluster,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of IntNMF_08082023")
...
getMoHeatmap(data          = plot_cluster_mvalue,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of IntNMF M value_08082023")
```
...
getMoHeatmap(data          = plot_cluster,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of MoCluster_08082023")
...
getMoHeatmap(data          = plot_cluster_mvalue,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of MoCluster M value_08082023")
```
...
getMoHeatmap(data          = plot_cluster,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of iClusterBayes_08082023")
...
getMoHeatmap(data          = plot_cluster_mvalue,
             ...
             width         = 10, 
             height        = 5, 
             fig.name      = "Comprehensive of iClusterBayes M value_08082023")
```
...
tbl_stack(list(tbl_bcc, tbl_iClusterBayes, tbl_NEMO, tbl_COCA,
               ...
               tbl_MoCluster))  %>%
  modify_caption("**select features with var")
